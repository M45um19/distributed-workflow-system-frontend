...
import { LayoutDashboard, LogOut, Loader2, Activity, X } from "lucide-react";
...
export default function DashboardSidebar({ isOpen, onClose }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`w-64 h-screen fixed left-0 top-0 bg-bg-dark border-r border-zinc-800/80 flex flex-col justify-between p-6 z-30 transition-transform duration-300 md:translate-x-0 ${
